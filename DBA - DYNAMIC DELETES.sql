...
----   , @TRANSACTION_NEEDED        BIT             = 0
----   , @ROLLBACK_OR_COMMIT        NVARCHAR(10)    = ''
...
----   , @OVERRIDE_ROW_TRAN_WARNING BIT             = 0
----   , @DEBUG_YN                  BIT             = 1
                                  
----)
----AS

--/* WRITTEN BY JOHN KAUFFMAN, BLOG AT SQLJOHNKAUFFMAN@WORDPRESS.COM
--   V1 - 6/26/12
--   Vx - 6/7/13
...
DECLARE     
   ...
   , @SERVER_INSTANCE           SYSNAME         = 'johnkauf-hp840'
   , @DB_NAME                   SYSNAME         = 'AdventureWorks2012'
   ...
   , @DECREASE_LOOP_AT_DURATION INT             = 10               -- IF A DELETE TAKES MORE THAN @DECREASE_LOOP_AT_DURATION SECONDS, THE @INNER_LOOP_SIZE WILL DECREASE BY @CHANGE_LOOP_BY
   ...
   , @TRUNCATE_YN               BIT             = 0                -- IN RARE CASES, IT MAY BE BETTER TO TRUNCATE THAN DELETE.  USE CAUTIOUSLY!!!  YOU CAN'T TRUNCATE A PARENT TABLE IF FKS EXIST.
   ...
   , @TRANSACTION_NEEDED        BIT             = 0                -- DON'T USE TRANSACTION IF DELETING LARGE NUMBERS OF RECORDS, ESPECIALLY IN PRODUCTION.  YOU'LL BLOCK.  THE ASSUMPTION IS THAT IF YOU'RE DELETING A FEW MILLION RECORDS, YOU WON'T MIND IF IT GETS INTERRUPTED MID-WAY, BECAUSE YOU'LL JUST PICK UP WHERE IT ENDED.
   , @ROLLBACK_OR_COMMIT        NVARCHAR(10)    = ''               -- WHEN @TRANSACTION_NEEDED = 1, VALUE MUST BE 'COMMIT' OR 'ROLLBACK'. 
   , @OVERRIDE_ROW_TRAN_WARNING BIT             = 0                -- BY DEFAULT, THE QUERY EXITS OUT IF THE ROWS TO BE DELETED > 50000 AND YOU CHOOSE TO WRAP IN A TRANSACTION TO MINIMIZE BLOCKING AND LOG GROWTH.  BUT, YOU KNOW YOUR SYSTEM AND YOUR REQUIREMENTS BETTER THAN I DO.  SO, GO FOR IT IF YOU NEED TO, BUT DON'T BLAME ME IF YOU BRING DOWN A PRODUCTION SYSTEM!
...
DECLARE @OVERRIDE_ROW_TRAN_WARNING    BIT     = <<@OVERRIDE_ROW_TRAN_WARNING>>                                   
/*
...
DECLARE @TRANSACTION_NEEDED    BIT             = <<@TRANSACTION_NEEDED>> 
DECLARE @ROLLBACK_OR_COMMIT    NVARCHAR(10)    = ''<<@ROLLBACK_OR_COMMIT>>''
...
DECLARE @TRUNCATE_YN           BIT             = <<@TRUNCATE_YN>>  -- NOT YET CODED.  IT''S A FAIRLY DANGEROUS ONE, SO I MAY NOT.
...
SET @SQL_SETUP= REPLACE(@SQL_SETUP, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_SETUP= REPLACE(@SQL_SETUP, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_SETUP= REPLACE(@SQL_SETUP, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_SETUP= REPLACE(@SQL_SETUP, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)

                                                                        
IF @PERSIST_METADATA = 0                                                   
   BEGIN
      SET @SQL_SETUP= REPLACE(@SQL_SETUP, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
...
SET @SQL_SETUP2= REPLACE(@SQL_SETUP2, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_SETUP2= REPLACE(@SQL_SETUP2, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_SETUP2= REPLACE(@SQL_SETUP2, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_SETUP2= REPLACE(@SQL_SETUP2, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)

IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_SETUP2= REPLACE(@SQL_SETUP2, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
IF @DEBUG_YN = 1
BEGIN
PRINT @SQL_SETUP2
...
'
      ...
      SET @MESSAGE = ''    TRUNCATE INSTEAD? '' + CASE WHEN @TRUNCATE_YN = 1 THEN ''YES'' ELSE ''NO'' END 
               exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message
               RAISERROR(@message, 0, 1) WITH NOWAIT 
      ...
      SET @MESSAGE = ''HOWEVER, IF THE DURATION IN THOSE FIRST 5 LOOPS IS OVER ' + CAST(@ALWAYS_REDUCE_IF_OVER AS NVARCHAR(10)) + ' SECONDS, THE QUERY WILL EXIT.''
               exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message
               RAISERROR(@message, 0, 1) WITH NOWAIT   
...
SET @SQL_SETUP3= REPLACE(@SQL_SETUP3, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_SETUP3= REPLACE(@SQL_SETUP3, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_SETUP3= REPLACE(@SQL_SETUP3, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_SETUP3= REPLACE(@SQL_SETUP3, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)

IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_SETUP3= REPLACE(@SQL_SETUP3, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
IF @DEBUG_YN = 1
BEGIN
PRINT @SQL_SETUP3
...
IF @TRANSACTION_NEEDED = 1 
   AND @ROLLBACK_OR_COMMIT NOT IN (''ROLLBACK'', ''COMMIT'')
   BEGIN
      SET @MESSAGE = ''   FAILED --- USER MUST SELECT TO ROLLBACK OR COMMIT WHEN SELECTING TO RUN IN A TRANSACTION.''
...
ELSE
   BEGIN
      SET @MESSAGE = ''   PASSED --- USER MUST SELECT TO ROLLBACK OR COMMIT WHEN SELECTING TO RUN IN A TRANSACTION.''

      exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message
      RAISERROR(@message, 0, 1) WITH NOWAIT 
   END

IF @TRANSACTION_NEEDED = 0 
   AND @ROLLBACK_OR_COMMIT  in (''commit'', ''rollback'')
   BEGIN
      SET @MESSAGE = ''   FAILED --- USER CANNOT SELECT TO ROLLBACK OR COMMIT WHEN NOT SELECTING TO RUN IN A TRANSACTION.''
...
ELSE
   BEGIN
      SET @MESSAGE = ''   PASSED --- USER SELECTED TO ROLLBACK OR COMMIT WHEN SELECTING TO RUN IN A TRANSACTION.''
...
SET @SQL_VALIDATION= REPLACE(@SQL_VALIDATION, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_VALIDATION= REPLACE(@SQL_VALIDATION, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_VALIDATION= REPLACE(@SQL_VALIDATION, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_VALIDATION= REPLACE(@SQL_VALIDATION, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)

IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_VALIDATION= REPLACE(@SQL_VALIDATION, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
IF @DEBUG_YN = 1
BEGIN
...
'
IF @TRUNCATE_YN <> 0
AND NOT (@WHERE_CLAUSE IS NULL)
   BEGIN
      SET @MESSAGE = ''   FAILED --- TRUNCATE NOT ALLOWED IF FILTER PARAMETERS ARE ENTERED.''
...
ELSE
   BEGIN
      SET @MESSAGE = ''   PASSED --- TRUNCATE NOT ALLOWED IF FILTER PARAMETERS ARE ENTERED.''
...
CHECKSUM(
        ''<<@TICKET_DESCRIPTION>>'' 
      + CAST(<<@TRANSACTION_NEEDED>>  AS NVARCHAR(1))   
      + ''<<@ROLLBACK_OR_COMMIT>>''    
      + ''<<@DB_NAME>>''       
      + ''<<@TABLE_NAME>>''            
      + ''<<@ID_COLUMN>>''             
      + ''<<@WHERE_CLAUSE>>''  
      + CAST(<<@TRUNCATE_YN>>  AS NVARCHAR(1))   
...
SET @SQL_VALIDATION2= REPLACE(@SQL_VALIDATION2, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_VALIDATION2= REPLACE(@SQL_VALIDATION2, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_VALIDATION2= REPLACE(@SQL_VALIDATION2, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_VALIDATION2= REPLACE(@SQL_VALIDATION2, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)


IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_VALIDATION2= REPLACE(@SQL_VALIDATION2, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
IF @DEBUG_YN = 1
BEGIN
...
SET @SQL_VALIDATION3= REPLACE(@SQL_VALIDATION3, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_VALIDATION3= REPLACE(@SQL_VALIDATION3, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_VALIDATION3= REPLACE(@SQL_VALIDATION3, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_VALIDATION3= REPLACE(@SQL_VALIDATION3, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)


IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_VALIDATION3= REPLACE(@SQL_VALIDATION3, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
IF @DEBUG_YN = 1
BEGIN
...
SET @SQL_VALIDATION4= REPLACE(@SQL_VALIDATION4, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_VALIDATION4= REPLACE(@SQL_VALIDATION4, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_VALIDATION4= REPLACE(@SQL_VALIDATION4, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_VALIDATION4= REPLACE(@SQL_VALIDATION4, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)

IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_VALIDATION4= REPLACE(@SQL_VALIDATION4, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
IF @DEBUG_YN = 1
BEGIN
...
CREATE TABLE #DELETE_LIST (PK_ID int NOT NULL,  row_num int not null  
                             PRIMARY KEY (row_num ))   
...
begin try
   INSERT  INTO #DELETE_LIST (PK_ID, row_num)
       SELECT  <<@ID_COLUMN>>, row_number() over(order by  <<@ID_COLUMN>>) as row_num  
...
BEGIN
   ...
   SET @SQL_DATA_LOAD= REPLACE(@SQL_DATA_LOAD, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
   SET @SQL_DATA_LOAD= REPLACE(@SQL_DATA_LOAD, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
   ...
   SET @SQL_DATA_LOAD= REPLACE(@SQL_DATA_LOAD, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
   ...
   SET @SQL_DATA_LOAD= REPLACE(@SQL_DATA_LOAD, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)
...
IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_DATA_LOAD= REPLACE(@SQL_DATA_LOAD, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
...
IF @ROW_COUNT > 50000 AND @OVERRIDE_ROW_TRAN_WARNING = 0 AND @TRANSACTION_NEEDED = 1
      BEGIN
         SET @message = ''   WRAPPING '' + CAST(@ROW_COUNT AS VARCHAR(10)) + '' ROWS IN A TRANSACTION IS NOT PERMITTED BY DEFAULT BECAUSE OF RISKS FOR BLOCKING AND LOG GROWTH.  SET @OVERRIDE_ROW_TRAN_WARNING TO 1 IF YOU HAVE TO DO THESE DELETES IN A TRANSACTION AND KNOW IT IS SAFE TO DO SO.''
               exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message
               RAISERROR(@message, 0, 1) WITH NOWAIT 
...
SET @SQL_DATA_LOAD2= REPLACE(@SQL_DATA_LOAD2, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_DATA_LOAD2= REPLACE(@SQL_DATA_LOAD2, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_DATA_LOAD2= REPLACE(@SQL_DATA_LOAD2, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_DATA_LOAD2= REPLACE(@SQL_DATA_LOAD2, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)

IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_DATA_LOAD2= REPLACE(@SQL_DATA_LOAD2, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
...
CASE WHEN @TRANSACTION_NEEDED = 1 THEN 'BEGIN TRAN   
' ELSE '' END
...
SET @SQL_LOOPING = @SQL_LOOPING + 
   ...
   while @sets_to_load > 0 -- OUTER LOOP
                  ...
                  if @counter%10 = 0
                     begin
                        ...
                        IF COALESCE(@MAX_LOG_SIZE_PCT , 0) > 0
                           AND @LOG_SIZE > COALESCE(@MAX_LOG_SIZE_PCT , 0)
                           BEGIN
                              SET @MESSAGE  = ''<<@DB_NAME>> LOG IS '' + CAST(@LOG_SIZE AS NVARCHAR(10)) + '' PCT FULL. EXITING.  RE-RUN WHEN LOG SIZE HAS REDUCED.''
                           ...
                           BEGIN
                              SET @MESSAGE  = ''<<@DB_NAME>> LOG IS '' + CAST(@LOG_SIZE AS NVARCHAR(10)) + '' PCT FULL, WHICH IS LESS THAN VALUE PROVIDED IN @MAX_LOG_SIZE_PCT. CONTINUING TO PROCESS.''

                              EXEC MASTER.DBO.USP_LOGSQLINFO @COMP_NAME, @MESSAGE
                              RAISERROR(@MESSAGE, 0, 1) WITH NOWAIT 
                           END -- msg about log OK

                     end -- check of log size
      ...
      '
                           SET @SQL_LOOPING = @SQL_LOOPING + 
                           CASE WHEN @TRANSACTION_NEEDED = 1 THEN '                 ROLLBACK
                           '
                           else '' END
...
SET @SQL_LOOPING= REPLACE(@SQL_LOOPING, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_LOOPING= REPLACE(@SQL_LOOPING, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_LOOPING= REPLACE(@SQL_LOOPING, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_LOOPING= REPLACE(@SQL_LOOPING, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)

IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_LOOPING= REPLACE(@SQL_LOOPING, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
...
'  
                  ...
                  SET @message = ''Processed from row '' + CAST(@counter AS nvarchar(30)) + '' to row '' + CAST(@END_ID AS nvarchar(30)) + ''. Time = '' + CONVERT(nvarchar(60),datediff(s, @start_time, @end_time)) + '' seconds''
                  RAISERROR(@message, 0, 1) WITH NOWAIT
                  ...
                  -- IF >= 70%, DOUBLE @CHANGE_LOOP_BY (TRYING TO ENSURE POTENTIAL BLOCKING IS MINIMIZED BY REDUCING SIZE FASTER IF POOR PERFORMANCE IS CONTINUING)

                  IF @INNER_LOOPS_TOTAL = 10 AND (@INNER_LOOP_DECREASES >= 3 OR @INNER_LOOP_INCREASES >= 7)
                     BEGIN
                        SET @MESSAGE = ''@CHANGE_LOOP_BY parameter changing from '' + CAST(@CHANGE_LOOP_BY AS NVARCHAR(10)) + '' to '' + CAST(( @CHANGE_LOOP_BY * 2) AS NVARCHAR(10)) + '' because the last 10 loops have '' + case when @INNER_LOOP_DECREASES >=3 then ''decreased '' + cast(@INNER_LOOP_DECREASES  as nvarchar(5)) else ''increased ''  + cast(@INNER_LOOP_INCREASES - @INNER_LOOP_DECREASES  as nvarchar(5))  end + '' times. (increase count subtracts decrease count.)''

                        exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message
                        RAISERROR(@message, 0, 1) WITH NOWAIT

                        SET @CHANGE_LOOP_BY = @CHANGE_LOOP_BY * 2  
                  ...
                  IF (@DECREASE_LOOP_AT_DURATION < datediff(s, @start_time, @end_time) AND @COUNTER > 5 )-- FIRST FEW LOOPS CAN BE SLOWER THAN THE REST
                    OR (datediff(s, @start_time, @end_time) > @ALWAYS_REDUCE_IF_OVER)
                     BEGIN
...
SET @SQL_LOOPING2= REPLACE(@SQL_LOOPING2, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_LOOPING2= REPLACE(@SQL_LOOPING2, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_LOOPING2= REPLACE(@SQL_LOOPING2, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_LOOPING2= REPLACE(@SQL_LOOPING2, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)

IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_LOOPING2= REPLACE(@SQL_LOOPING2, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
...
'
                  ...
                  IF @INNER_LOOP_SIZE < 1  -- if decrease takes loop count below 1, adjust loop back to prior value, and apply half the loop reduction.  may still result in value less than 0, but it''s a decent initial attempt.
                     BEGIN
                        ...
                        SET @MESSAGE = ''LOOP SIZE CANNOT BE <1.  LOOP SIZE ADJUSTING FROM '' + CAST(@INNER_LOOP_SIZE AS NVARCHAR(10)) + '' TO '' + CAST(@INNER_LOOP_SIZE + @change_loop_by - (@CHANGE_LOOP_BY/2) AS NVARCHAR(10)) 
            ...
            /* CHECK LOG SIZE AT END OF EVERY OUTER LOOP, IN CASE @INNER_LOOP_SIZE IS VERY LARGE AND SOMEHOW LOG DOESN''T GET CHECKED IN THE INNER LOOP.*/
            SELECT @LOG_SIZE =  CNTR_VALUE
            FROM SYS.DM_OS_PERFORMANCE_COUNTERS
            WHERE COUNTER_NAME = ''PERCENT LOG USED ''
            AND INSTANCE_NAME IN( ''<<@DB_NAME>>'')
...
SET @SQL_LOOPING3 = @SQL_LOOPING3 + 
CASE WHEN @TRANSACTION_NEEDED = 1 THEN  '         ' +coalesce(@ROLLBACK_OR_COMMIT, '')
else '' END
...
SET @SQL_LOOPING3= REPLACE(@SQL_LOOPING3, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_LOOPING3= REPLACE(@SQL_LOOPING3, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_LOOPING3= REPLACE(@SQL_LOOPING3, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_LOOPING3= REPLACE(@SQL_LOOPING3, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)

IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_LOOPING3= REPLACE(@SQL_LOOPING3, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
...
'
         ...
         IF @ROLLBACK_OR_COMMIT = ''ROLLBACK''
            BEGIN
               SET @message = ''TRANSACTION ROLLED BACK.  TO COMMIT, REGENERATE SCRIPT AND RE-RUN.''
               exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message
               RAISERROR(@message, 0, 1) WITH NOWAIT 
            END

         IF @ROLLBACK_OR_COMMIT = ''COMMIT''
            BEGIN
               SET @message = ''TRANSACTION COMMITTED. ''
               exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message
               RAISERROR(@message, 0, 1) WITH NOWAIT 
            END
...
SET @SQL_LOOPING4= REPLACE(@SQL_LOOPING4, '<<@TRANSACTION_NEEDED>> ',      @TRANSACTION_NEEDED)
SET @SQL_LOOPING4= REPLACE(@SQL_LOOPING4, '<<@ROLLBACK_OR_COMMIT>>',       @ROLLBACK_OR_COMMIT)
...
SET @SQL_LOOPING4= REPLACE(@SQL_LOOPING4, '<<@TRUNCATE_YN>>',              @TRUNCATE_YN)
...
SET @SQL_LOOPING4= REPLACE(@SQL_LOOPING4, '<<@OVERRIDE_ROW_TRAN_WARNING>>',@OVERRIDE_ROW_TRAN_WARNING)

IF @PERSIST_METADATA = 0
   BEGIN
      SET @SQL_LOOPING4= REPLACE(@SQL_LOOPING4, 'exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message', '---- exec master.dbo.usp_LogSQLInfo @COMP_NAME, @message')
   END
...
SET @ALL_SQL = @SQL_SETUP + @SQL_SETUP2 + @SQL_SETUP3 
                 ...
                 + @SQL_DATA_LOAD 
                 + @SQL_LOOPING + @SQL_LOOPING2 + @SQL_LOOPING3
